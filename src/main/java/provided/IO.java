...
public class IO {
	 ...
	 * zur�ck, dessen Elemente die einzelnen Zeichen der Datei enthalten;
	 ...
	 * zwei-dimensionale char-Array zur�ck, dessen Elemente die Zeichen der Datei
	 ...
	 * zur�ck, dessen Elemente die einzelnen Zeilen der Datei enthalten
	 * 
	 * @param filename Name der auszulesenden Datei
